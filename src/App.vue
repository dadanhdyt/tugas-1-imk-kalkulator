...
<template>
  <div class="flex items-center justify-center h-screen px-3 bg-gray-900 sm:px-0">
    <div class="w-full mx-auto bg-gray-700 rounded shadow-xl sm:max-w-sm" data-step="1"
      ...
      <div data-step="3" data-intro="Menampilkan operasi yang anda inputkan dan menampilkan hasil inputan anda"
        class="bg-slate-500 flex justify-end items-end p-3 h-[120px]">
